...
## It can store the objects standing above the tile and render them.

const DUNGEON_TILE_HIGHLIGHT = preload("res://entities/tiles/assets/dungeon_tile_highlight.png")
const DUNGEON_TILE_SELECTED = preload("res://entities/tiles/assets/dungeon_tile_selected.png")
