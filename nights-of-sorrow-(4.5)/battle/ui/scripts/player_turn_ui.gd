...
@onready var battle_text: BattleText = $CanvasLayer/BattleText
...
func start_state_skill():
	var skills = [preload("uid://clc4eit80noqe"), preload("uid://bfn8tjlfqc4jo"), preload("uid://cfsnfgbh2l7dj"), preload("uid://buh4m1bca1olj")]
